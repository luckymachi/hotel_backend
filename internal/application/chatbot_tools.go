...
func (rt *ReservationTools) GetToolDescriptions() string {
	...
	sb.WriteString("1. get_room_types\n")
	sb.WriteString("   Uso: [USE_TOOL: get_room_types]\n{}\n[END_TOOL]\n\n")

	sb.WriteString("2. check_availability\n")
	sb.WriteString("   Uso: [USE_TOOL: check_availability]\n{\"fechaEntrada\":\"2025-12-27\",\"fechaSalida\":\"2026-01-04\"}\n[END_TOOL]\n\n")

	sb.WriteString("3. calculate_price\n")
	sb.WriteString("   Uso: [USE_TOOL: calculate_price]\n{\"tipoHabitacionId\":6,\"fechaEntrada\":\"2025-12-27\",\"fechaSalida\":\"2026-01-04\"}\n[END_TOOL]\n\n")

	sb.WriteString("4. generate_booking_link - USA ESTA cuando usuario confirme la reserva\n")
	sb.WriteString("   Uso: [USE_TOOL: generate_booking_link]\n")
	sb.WriteString("   {\"fechaEntrada\":\"2025-12-27\",\"fechaSalida\":\"2026-01-04\",\"tipoHabitacionId\":6,\"cantidadAdultos\":2,\"cantidadNinhos\":0,\"email\":\"user@email.com\"}\n")
	sb.WriteString("   [END_TOOL]\n\n")

	sb.WriteString("IMPORTANTE:\n")
	sb.WriteString("- USA generate_booking_link cuando el usuario dice: 'confirmar', 'sí', 'adelante', 'continuar'\n")
	sb.WriteString("- NO inventes URLs - SIEMPRE usa la herramienta\n")
	sb.WriteString("- El formato DEBE ser exacto: [USE_TOOL: nombre]\\n{json}\\n[END_TOOL]\n")
